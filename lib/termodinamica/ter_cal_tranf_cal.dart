...
class CalcTransCal extends StatefulWidget {
  const CalcTransCal({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CalcTransCalState createState() => _CalcTransCalState();
}

class _CalcTransCalState extends State<CalcTransCal> {
