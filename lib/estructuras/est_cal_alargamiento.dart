...
class CalcAlargamientoEqyCom extends StatefulWidget {
  const CalcAlargamientoEqyCom({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CalcAlargamientoEqyComState createState() => _CalcAlargamientoEqyComState();
}

class _CalcAlargamientoEqyComState extends State<CalcAlargamientoEqyCom> {
